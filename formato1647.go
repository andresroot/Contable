...
func Formato1647(w http.ResponseWriter, r *http.Request) {
	listaformato := []miFormatoExcel{}
	listaformato = generarformato("1647", false)
	f := excelize.NewFile()
	...
	f.SetCellValue("Sheet1", "J1", "PAIS")
	f.SetCellValue("Sheet1", "K1", "COLUMNA1")
	f.SetCellValue("Sheet1", "L1", "COLUMNA1")
	f.SetCellValue("Sheet1", "M1", "COLUMNA1")
	f.SetCellValue("Sheet1", "N1", "TIPO")
	f.SetCellValue("Sheet1", "O1", "DOCUMENTO")
	f.SetCellValue("Sheet1", "P1", "PRIMER APELLIDO")
	f.SetCellValue("Sheet1", "Q1", "SEGUNDO APELLIDO")
	f.SetCellValue("Sheet1", "R1", "PRIMER NOMBRE")
	f.SetCellValue("Sheet1", "S1", "SEGUNDO NOMBRE")
	f.SetCellValue("Sheet1", "T1", "RAZON SOCIAL")
	f.SetCellValue("Sheet1", "U1", "DIRECCION")
	f.SetCellValue("Sheet1", "V1", "DEPARTAMENTO")
	f.SetCellValue("Sheet1", "W1", "CIUDAD")
	f.SetCellValue("Sheet1", "X1", "PAIS")
	...
	for i, miFila := range listaformato {
		...
		f.SetCellValue("Sheet1", "J"+a, miFila.Pais)
		f.SetCellValue("Sheet1", "K"+a, Flotante(miFila.Columna1))
		f.SetCellValue("Sheet1", "L"+a, Flotante(miFila.Columna1))
		f.SetCellValue("Sheet1", "M"+a, Flotante(miFila.Columna1))
		f.SetCellValue("Sheet1", "N"+a, miFila.Documento)
		f.SetCellValue("Sheet1", "O"+a, miFila.Codigo)
		f.SetCellValue("Sheet1", "P"+a, miFila.PrimerApllido)
		f.SetCellValue("Sheet1", "Q"+a, miFila.SegundoApellido)
		f.SetCellValue("Sheet1", "R"+a, miFila.PrimerNombre)
		f.SetCellValue("Sheet1", "S"+a, miFila.SegundoNombre)
		f.SetCellValue("Sheet1", "T"+a, miFila.Juridica)
		f.SetCellValue("Sheet1", "U"+a, miFila.Direccion)
		f.SetCellValue("Sheet1", "V"+a, miFila.Departamento)
		f.SetCellValue("Sheet1", "W"+a, miFila.Ciudad)
		f.SetCellValue("Sheet1", "X"+a, miFila.Pais)
		...
		f.SetCellStyle("Sheet1", "N"+a, "N"+a, estiloTexto)
		f.SetCellStyle("Sheet1", "O"+a, "O"+a, estiloTexto)
		f.SetCellStyle("Sheet1", "P"+a, "P"+a, estiloTexto)
		f.SetCellStyle("Sheet1", "Q"+a, "Q"+a, estiloTexto)
		f.SetCellStyle("Sheet1", "R"+a, "R"+a, estiloTexto)
		f.SetCellStyle("Sheet1", "S"+a, "S"+a, estiloTexto)
		f.SetCellStyle("Sheet1", "T"+a, "T"+a, estiloTexto)
		f.SetCellStyle("Sheet1", "U"+a, "U"+a, estiloTexto)
		f.SetCellStyle("Sheet1", "V"+a, "V"+a, estiloTexto)
		f.SetCellStyle("Sheet1", "W"+a, "W"+a, estiloTexto)
		f.SetCellStyle("Sheet1", "X"+a, "X"+a, estiloTexto)
	}
