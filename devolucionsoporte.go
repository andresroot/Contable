...
func DevolucionsoporteConsultaDetalle() string {
	...
	consulta += "inner join bodega on bodega.codigo=devolucionsoportedetalle.bodega "
	consulta += " where devolucionsoportedetalle.codigo=$1 ORDER BY fila"
...
func DevolucionsoporteNuevo(w http.ResponseWriter, r *http.Request) {
	...
	miTemplate, err := template.ParseFiles("vista/inicio/Modulo.html",
		"vista/devolucionsoporte/devolucionsoporteNuevo.html",
...
func DevolucionsoporteAgregar(w http.ResponseWriter, r *http.Request) {
	...
	Codigoactual = tempDevolucionsoporte.Codigo
	if tempDevolucionsoporte.Accion == "Actualizar" {
		...
		Borrarinventario(tempDevolucionsoporte.Codigo, "Devolucionsoporte")
	...
	for _, x := range tempDevolucionsoporte.Detalle {
	...
	_, err = insForm.Exec(
		...
		Quitacoma(tempDevolucionsoporte.Descuento),
		Quitacoma(tempDevolucionsoporte.Subtotaldescuento19),
		Quitacoma(tempDevolucionsoporte.Subtotaldescuento5),
		Quitacoma(tempDevolucionsoporte.Subtotaldescuento0),
		Quitacoma(tempDevolucionsoporte.Subtotal),
		Quitacoma(tempDevolucionsoporte.Subtotal19),
		Quitacoma(tempDevolucionsoporte.Subtotal5),
		Quitacoma(tempDevolucionsoporte.Subtotal0),
		Quitacoma(tempDevolucionsoporte.Subtotaliva19),
		Quitacoma(tempDevolucionsoporte.Subtotaliva5),
		Quitacoma(tempDevolucionsoporte.Subtotaliva0),
		Quitacoma(tempDevolucionsoporte.Subtotalbase19),
		Quitacoma(tempDevolucionsoporte.Subtotalbase5),
		Quitacoma(tempDevolucionsoporte.Subtotalbase0),
		Quitacoma(tempDevolucionsoporte.TotalIva),
		Quitacoma(tempDevolucionsoporte.Total),
		Quitacoma(tempDevolucionsoporte.Neto),
		tempDevolucionsoporte.Items,
		Quitacoma(tempDevolucionsoporte.PorcentajeRetencionFuente),
		Quitacoma(tempDevolucionsoporte.TotalRetencionFuente),
		Quitacoma(tempDevolucionsoporte.PorcentajeRetencionIca),
		Quitacoma(tempDevolucionsoporte.TotalRetencionIca),
...
func DevolucionsoporteBorrar(w http.ResponseWriter, r *http.Request) {
	...
	miTemplate, err := template.ParseFiles("vista/inicio/Modulo.html",
		"vista/devolucionsoporte/devolucionsoporteBorrar.html",
		"vista/autocompleta/autocompletaFormadepago.html",
		"vista/autocompleta/autocompletaMediodepago.html",
		"vista/autocompleta/autocompletaAlmacenista.html",
		"vista/autocompleta/autocompletaCentro.html",
...
func DatosSoporte(w http.ResponseWriter, r *http.Request) {
	...
	// traer SOPORTE
	v := soporte{}
	err := db.Get(&v, "SELECT * FROM soporte where codigo=$1 and Tercero=$2", Codigo, Tercero)
	var valida bool
	valida = true
...
func DevolucionsoportePieDePagina(pdf *gofpdf.Fpdf, miTercero tercero, miDevolucionsoporte devolucionsoporte) {
	...
	if miDevolucionsoporte.Neto != "0" {
		...
		pdf.CellFormat(190, 4, "TOTAL", "0", 0, "L",
			false, 0, "")
		pdf.SetX(15)
		pdf.CellFormat(190, 4, Coma(miDevolucionsoporte.Neto), "0", 0, "R",
			false, 0, "")
		separador += altoseparador
	}

	if miDevolucionsoporte.TotalRetencionIca != "0" {
		pdf.SetY(separador)
		pdf.SetX(145)
		pdf.CellFormat(190, 4, "RET. ICA.", "0", 0, "L",
			false, 0, "")
		pdf.SetX(168)
		pdf.CellFormat(190, 4, miDevolucionsoporte.PorcentajeRetencionIca+"%", "0", 0, "L",
			false, 0, "")
		pdf.SetX(15)
		pdf.CellFormat(190, 4, Coma(miDevolucionsoporte.TotalRetencionIca), "0", 0, "R",
			false, 0, "")
		separador += altoseparador
	}

	if miDevolucionsoporte.TotalRetencionFuente != "0" {
		pdf.SetY(separador)
		pdf.SetX(145)
		pdf.CellFormat(190, 4, "RET. FTE.", "0", 0, "L",
			false, 0, "")
		pdf.SetX(168)
		pdf.CellFormat(190, 4, miDevolucionsoporte.PorcentajeRetencionFuente+"%", "0", 0, "L",
			false, 0, "")
		pdf.SetX(15)
		pdf.CellFormat(190, 4, Coma(miDevolucionsoporte.TotalRetencionFuente), "0", 0, "R",
			false, 0, "")
		separador += altoseparador
	}

	if miDevolucionsoporte.Subtotalbase5 != "0" {
		pdf.SetY(separador)
		pdf.SetX(145)
		...
		pdf.CellFormat(190, 4, "5%", "0", 0, "L",
			false, 0, "")
		pdf.SetX(15)
		pdf.CellFormat(190, 4, Coma(miDevolucionsoporte.Subtotalbase5), "0", 0, "R",
			false, 0, "")
		separador += altoseparador
	}

	if miDevolucionsoporte.Subtotalbase19 != "0" {
		pdf.SetY(separador)
		pdf.SetX(145)
		pdf.CellFormat(190, 4, "GRAVABLE", "0", 0, "L",
			false, 0, "")
		...
		pdf.CellFormat(190, 4, "19%", "0", 0, "L",
			false, 0, "")
		pdf.SetX(15)
		pdf.CellFormat(190, 4, Coma(miDevolucionsoporte.Subtotalbase19), "0", 0, "R",
			false, 0, "")
		separador += altoseparador
	}

	if miDevolucionsoporte.Subtotalbase0 != "0" {
		pdf.SetY(separador)
		pdf.SetX(145)
		pdf.CellFormat(190, 4, "NO GRAVABLE", "0", 0, "L",
			false, 0, "")
		pdf.SetX(15)
		pdf.CellFormat(190, 4, Coma(miDevolucionsoporte.Subtotalbase0), "0", 0, "R",
			false, 0, "")
		separador += altoseparador
	}
...
func DevolucionsoporteLinea(pdf *gofpdf.Fpdf) {
	pdf.SetY(259)
	pdf.Line(20, 259, 204, 259)
}

// INICIA DEVOLUCION SOPORTE TODOS PDF
func DevolucionsoporteTodosCabecera(pdf *gofpdf.Fpdf) {
	pdf.SetFont("Arial", "", 10)
	// RELLENO TITULO
	pdf.SetY(50)
	pdf.SetFillColor(224, 231, 239)
...
func DevolucionsoporteTodosDetalle(pdf *gofpdf.Fpdf, miFila Devolucionsoportelista, a int) {
	pdf.SetFont("Arial", "", 9)
	pdf.SetX(21)
...
func DevolucionsoporteTodosPdf(w http.ResponseWriter, r *http.Request) {
	db := dbConn()
	var consulta string
	consulta = "  SELECT almacenista.nombre as AlmacenistaNombre,centro.nombre as CentroNombre,devolucionsoporte.neto,devolucionsoporte.codigo,fecha,tercero,tercero.nombre as TerceroNombre "
	consulta += " FROM devolucionsoporte "
	...
	consulta += " inner join centro on centro.codigo=devolucionsoporte.centro "
	consulta += " inner join almacenista on almacenista.codigo=devolucionsoporte.almacenista "
	consulta += " ORDER BY cast(devolucionsoporte.codigo as integer) ASC"

	t := []Devolucionsoportelista{}
	...
	pdf.SetHeaderFunc(func() {
		...
		pdf.CellFormat(190, 10, ene(c.NombreCiudad+" - "+c.NombreDepartamento), "0", 0, "C", false, 0,
			"")
		pdf.Ln(6)
		pdf.CellFormat(190, 10, "DATOS DEVOLUCION SOPORTE", "0", 0,
			"C", false, 0, "")
		pdf.Ln(10)
	})
	...
	DevolucionsoporteTodosCabecera(pdf)
	// tercera pagina
	...
	for i, miFila := range t {
		...
		DevolucionsoporteTodosDetalle(pdf, miFila, a)
	}
...
// TERMINA DEVOLUCION SOPORTE TODOS PDF

// DEVOLUCION SOPORTE EXCEL
func DevolucionsoporteExcel(w http.ResponseWriter, r *http.Request) {
	db := dbConn()
	var consulta string
	consulta = "  SELECT almacenista.nombre as AlmacenistaNombre,centro.nombre as CentroNombre,devolucionsoporte.neto,devolucionsoporte.codigo,fecha,tercero,tercero.nombre as TerceroNombre "
	consulta += " FROM devolucionsoporte "
	...
	f.SetCellValue("Sheet1", "A9", "LISTADO DE DEVOLUCION SOPORTE")
