...
type configuracionnomina struct {
...
func Datosinicialesconfiguracionnomina(){
	var q string
	q= "INSERT INTO configuracionnomina("
	q+="	compracuenta19	 , "
	q+="	compranombre19	 , "
	q+="	compracuenta5	 , "
	q+="	compranombre5	 , "
...
// CONFIGURACIONNOMINA NUEVO
func ConfiguracionnominaNuevo(w http.ResponseWriter, r *http.Request) {
	tmp,  err := template.ParseFiles("vista/inicio/Modulo.html",
		"vista/configuracionnomina/configuracionnominaNuevo.html",
		"vista/autocompleta/autocompletaPlandecuentaempresa.html",
		"vista/configuracionnomina/configuracionnominacompra.html",
		"vista/configuracionnomina/configuracionnominaventa.html",
		"vista/configuracionnomina/configuracionnominaventaservicio.html",
		"vista/configuracionnomina/configuracionnominasoporte.html",
		"vista/configuracionnomina/configuracionnominasoporteservicio.html",
		"vista/configuracionnomina/configuracionnominafacturagasto.html",
		"vista/configuracionnomina/configuracionnominageneral.html")
	...
	db := dbConn()
	var total int
	row := db.QueryRow("SELECT COUNT(*) FROM configuracionnomina  ")
	err = row.Scan(&total)
	if err != nil {
		log.Fatal(err)
	}
	...
	if total > 0 {
		...
		log.Println("consultar configuracion nomina4444 ")
		Datosinicialesconfiguracionnomina()
		//resultado = false
	}
	...
	log.Println("consultar configuracion nomina0111122 ")

	//TRAE ESTRUCTURA DE LA TABLA
	emp := configuracionnomina{}
	err1 := db.Get(&emp, "SELECT * FROM configuracionnomina")
	if err1 != nil {
		log.Println("Error consulta ")
		log.Fatalln(err)
	}

	log.Println("consultar configuracion nomina ")
...
// CONFIGURACIONNOMINA INSERTAR
func ConfiguracionnominaInsertar(w http.ResponseWriter, r *http.Request) {
	db := dbConn()
	...
	if r.Method == "POST" {
		...
		var consulta="INSERT INTO configuracionnomina("
		...
		consulta+=")VALUES("
		consulta+=parametros(212)
		consulta+=")"

		delForm, err := db.Prepare("DELETE from configuracionnomina")
		if err != nil {
			panic(err.Error())
		}
		delForm.Exec()
	...
	http.Redirect(w, r, "/ConfiguracionnominaNuevo/"+panel, 301)
}

// INICIA CONFIGURACIONINVENTARIO PDF
func ConfiguracionnominaPdf(w http.ResponseWriter, r *http.Request) {
	db := dbConn()
	Compracuenta19 := mux.Vars(r)["compracuenta19"]
	t := configuracionnomina{}
	var e  empresa=ListaEmpresa()
	var c  ciudad=TraerCiudad(e.Ciudad)
	err := db.Get(&t, "SELECT * FROM configuracionnomina where compracuenta19=$1", Compracuenta19)
	if err != nil {
		log.Fatalln(err)
	}
