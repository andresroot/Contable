...
func Formato1006(w http.ResponseWriter, r *http.Request) {
	listaformato := []miFormatoExcel{}
	listaformato = generarformato("1006", false)
	f := excelize.NewFile()
	...
	f.SetCellValue("Sheet1", "K1", "COLUMNA3")
	var filaExcel = 2
	//var a string
	//	var a = ""
	//var van int
	...
	for i, miFila := range listaformato {
		...
		f.SetCellValue("Sheet1", "K"+a, Flotante(miFila.Columna3))
