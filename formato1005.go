...
func Formato1005(w http.ResponseWriter, r *http.Request) {
	listaformato := []miFormatoExcel{}
	listaformato = generarformato("1005", false)
	f := excelize.NewFile()
	...
	f.SetCellValue("Sheet1", "I1", "COLUMNA1")
	f.SetCellValue("Sheet1", "J1", "COLUMNA2")
	...
	for i, miFila := range listaformato {
		...
		f.SetCellValue("Sheet1", "I"+a, Flotante(miFila.Columna1))
		f.SetCellValue("Sheet1", "J"+a, Flotante(miFila.Columna2))
		...
		f.SetCellStyle("Sheet1", "J"+a, "I"+a, estiloNumeroDetalle)
		f.SetCellStyle("Sheet1", "K"+a, "J"+a, estiloNumeroDetalle)
	}
