...
func CentroNuevo(w http.ResponseWriter, r *http.Request) {
	...
	tmp, _ := template.ParseFiles("vista/inicio/Modulo.html",
		...
		"vista/centro/autocompletaCentrocrear.html")
...
func CentroActualConsulta(w http.ResponseWriter, r *http.Request) {
	var tabla="centro"
	Codigo := mux.Vars(r)["codigo"]
	emp := buscarParametro{}
	var res []buscarParametro
...
// CENTRO BUSCAR NOMBRE
func CentroBuscarCrear(w http.ResponseWriter, r *http.Request) {
	db := dbConn()
	Codigo := mux.Vars(r)["codigo"]
	var tabla="centro"
...
func CentroPdf(w http.ResponseWriter, r *http.Request) {
	...
	pdf.SetHeaderFunc(func() {
		...
		pdf.SetX(20)
		pdf.CellFormat(184, 6, "CENTRO DE COSTOS", "0", 0,
			"C", true, 0, "")
		pdf.Ln(8)
	})
...
func CentroExcel(w http.ResponseWriter, r *http.Request) {
	...
	f.SetCellValue("Sheet1", "A9","DATOS CENTRO DE COSTOS")
